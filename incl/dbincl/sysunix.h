...
#if 0
extern void * bcl_malloc_chk _(( size_t, char *, long ));
extern void * bcl_realloc_chk _(( void *,size_t, char *, long ));
extern void * bcl_calloc_chk _(( size_t, size_t, char *, long ));
extern void bcl_free_chk _(( void *, char *, long ));
#else
extern void * bcl_malloc _(( size_t, char *, int ));
extern void * bcl_realloc _(( void *,size_t, char *, int ));
extern void * bcl_calloc _(( size_t, size_t, char *, int ));
extern void bcl_free _(( void *, char *, int ));
#endif
...
#define malloc(x) bcl_malloc(x,__FILE__,__LINE__)
#define realloc(x,y) bcl_realloc(x,y,__FILE__,__LINE__)
#define calloc(x,y) bcl_calloc(x,y,__FILE__,__LINE__)
#define free(x) bcl_free(x,__FILE__,__LINE__)
#endif
